...
const recommendedOxlintRuleConfig = JSON.parse(
  fs.readFileSync(
    new URL("../oxlint/meridian-local-rules.json", import.meta.url),
    "utf8",
  ),
);
...
const STRICT_ADDITIONS = {
  ...
  "meridian-local/no-excessive-component-props": "warn",
  "meridian-local/no-prop-bags": "warn",
};

const PILOT_OVERRIDES = {
  "meridian-local/no-inline-object-literals-in-jsx": "warn",
  "meridian-local/no-pre-jsx-mark-builder-loops": "warn",
  "meridian-local/no-mixed-chart-setup-and-markup-in-component": "warn",
...
export const meridianLocalRecommendedRuleProfile = cloneRules(
  recommendedOxlintRuleConfig.rules,
);
...
export const meridianLocalProfileNames = Object.freeze(
  Object.keys(meridianLocalRuleProfiles),
);
